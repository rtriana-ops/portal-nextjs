...
interface BannerMaysProgramsContentProps {
  onClose?: () => void
}

export function BannerMaysProgramsContent({ onClose }: BannerMaysProgramsContentProps) {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-4 py-4 md:py-4">
      <div
        className="w-full px-4 py-4 md:py-4 max-h-[200px] rounded-lg"
        style={{
        ...
        <div className="flex items-start gap-3 md:gap-3">
          ...
          <div className="flex-1 flex flex-col gap-2 md:gap-2">
            ...
            <h2 className="font-['Outfit',sans-serif] font-bold leading-[1.2] text-[#0f172a] text-[18px] md:text-[20px] tracking-[-0.5px]">
              <span className="text-[18px] text-[#172554] font-normal">Sign before 3:00 PM today to </span>
              <br />
