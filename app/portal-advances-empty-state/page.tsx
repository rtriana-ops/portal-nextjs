...
export default function PortalAdvancesEmptyStatePage() {
      ...
      {isSidebarOpen && (
        ...
        <main className="flex-1 px-4 py-4 lg:py-8">
          ...
          <div className="bg-transparent lg:bg-white rounded-2xl border p-6 lg:p-8 w-full md:max-w-[600px] xl:max-w-[1100px] border-gray-200 shadow-none lg:shadow-md px-0 py-0 md:mx-auto lg:ml-0 lg:mt-20">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-2.5">
              {/* Welcome Section */}
              <div className="mb-6 lg:mb-0">
                <h2 className="mb-2 lg:text-3xl text-center lg:text-left text-blue-950 font-bold font-serif text-3xl">Your Advances</h2>
                <p className="font-sans text-center text-slate-900 text-sm">Check your balances and next payments.</p>
              </div>
            ...
            {/* Advances Grid Layout */}
            <div className="mt-8">
              {/* Empty State */}
              <div className="flex items-center justify-center py-12 lg:py-20">
                <div className="text-center">
                  <div className="mb-6 flex justify-center">
                    <img src="/images/smiling-arms-crossed.svg" alt="No pending actions" className="h-40 w-40" />
                  </div>
                  <h3 className="text-xl font-bold text-blue-600 mb-2">You don't have any pending actions!</h3>
                  <p className="text-gray-600">When you start completing your tasks, everything will show up here.</p>
                </div>
              </div>
            </div>
          </div>
