...
export default function BusinessStartDatePage() {
  ...
  const handleContinue = () => {
    if (selectedMonth && selectedYear) {
      console.log("Business started:", selectedMonth, selectedYear)
        ...
        <div className="max-w-md mx-auto space-y-8">
          <div>
            ...
            <p className="text-gray-600 text-base">
              This helps us understand how long your business has been operating.
            </p>
          </div>
