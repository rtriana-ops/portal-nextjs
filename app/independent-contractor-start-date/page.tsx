...
export default function IndependentContractorStartDatePage() {
  ...
  useEffect(() => {
    const checkPosition = () => {
      ...
      if (yearButtonRef.current) {
        ...
        const viewportHeight = window.innerHeight
        const spaceBelow = viewportHeight - rect.bottom
        const dropdownHeight = 320 // h-[320px]
        ...
        <div className="max-w-md mx-auto space-y-8">
          <div>
            ...
            <p className="text-gray-600 text-base">
              This helps us understand how long you've been working independently.
            </p>
          </div>
