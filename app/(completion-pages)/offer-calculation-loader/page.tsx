...
export default function OfferCalculationLoaderPage() {
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="w-full space-y-4">
              ...
              >
                ...
                <p className="text-gray-900 text-base font-sans font-normal">Analyzing your information</p>
              </div>
              ...
              >
                ...
                <p className="text-gray-900 text-base">Processing your data</p>
              </div>
              ...
              >
                ...
                <p className="text-slate-950 font-sans font-normal text-base">Generating offers</p>
              </div>

              {/* Bullet 4 - Completed (Not pulsing) */}
              <div
                className={`flex items-center gap-3 transition-all duration-[2000ms] ${
              ...
              >
                ...
                <p className="text-slate-950 font-sans font-normal text-base">Preparing your results</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white w-full max-w-md rounded-t-3xl sm:rounded-3xl shadow-2xl max-h-[90vh] overflow-y-auto relative animate-in slide-in-from-bottom duration-300 sm:animate-in sm:zoom-in-95">
            ...
            {plaidScreen === "intro" && (
              <div className="p-6 pb-8 space-y-6">
                ...
                <button
                  onClick={handleClosePlaidModal}
                  className="w-full py-3 px-6 rounded-full font-semibold text-base bg-gray-200 text-gray-900 hover:bg-gray-300 transition-colors"
                >
                  Skip for now
                </button>
              </div>
            ...
            {/* Second Screen - Confirm */}
            {plaidScreen === "confirm" && (
              <div className="p-6 pb-8 space-y-6">
                {/* Title */}
                <h2 className="text-2xl font-bold text-center text-gray-900 pt-4">
                  Have you used Plaid before for banking connections?
                </h2>

                {/* Yes Button */}
                <button
                  onClick={() => setIsPaidYes(true)}
                  className={`w-full py-4 px-6 rounded-full font-semibold text-base transition-colors ${
                    isPaidYes === true
                      ? "bg-black text-white"
                ...
                {/* Share button - only show when an option is selected */}
                {isPaidYes !== null && (
                  <button
                    onClick={handleShare}
                    disabled={isSubmitting}
                    className="w-full py-4 px-6 rounded-full font-semibold text-base bg-emerald-500 text-white hover:bg-emerald-600 transition-colors disabled:opacity-50"
                  >
                    {isSubmitting ? "Continuing..." : "Share with Plaid"}
                  </button>
                )}
              </div>
            )}
