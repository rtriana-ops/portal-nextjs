...
export default function LoaderLayerPage() {
  ...
  useEffect(() => {
    ...
    const bullet3Timer = setTimeout(() => setVisibleBullets([1, 2, 3]), 2000)
    const bullet4Timer = setTimeout(() => setVisibleBullets([1, 2, 3, 4]), 3000)
    const bullet5Timer = setTimeout(() => {
      setVisibleBullets([1, 2, 3, 4, 5])
      setAllBulletsDone(true)
    }, 4000)

    // Redirect after 8 seconds
    const redirectTimer = setTimeout(() => {
      router.push("/offer-calculation")
    }, 8000)
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="w-full space-y-4">
              ...
              >
                ...
                <p className="text-gray-900 text-base font-sans font-normal">Getting your financial information</p>
              </div>
              ...
              >
                ...
                <p className="text-gray-900 text-base">Analyzing your financial details</p>
              </div>

              {/* Bullet 3 - Completed (Green) */}
              <div
                className={`flex items-center gap-3 transition-all duration-[2000ms] ${
              ...
              >
                ...
                <p className="text-slate-950 font-sans font-normal text-base">Running eligibility checks</p>
              </div>

              {/* Bullet 4 - Completed (Green) */}
              <div
                className={`flex items-center gap-3 transition-all duration-[2000ms] ${
                  visibleBullets.includes(4)
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-2"
                }`}
                style={{
                  animation: visibleBullets.includes(4)
                    ? "fade-in-slow 1s ease-in-out forwards"
                    : "none",
                }}
              >
                ...
                <p className="text-gray-900 text-base font-sans font-normal">Calculating your offer</p>
              </div>

              {/* Bullet 5 - Pulsing (Currently processing) */}
              <div
                className={`flex items-center gap-3 transition-all duration-[2000ms] ${
                  visibleBullets.includes(5)
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-2"
                }`}
                style={{
                  animation: visibleBullets.includes(5)
                    ? "fade-in-slow 1s ease-in-out forwards"
                    : "none",
                }}
              >
                ...
                <p className="text-slate-950 font-bold font-sans text-lg">Preparing your results</p>
              </div>
            </div>
          </div>
        </div>
            ...
            {plaidScreen === "confirm" && (
              <div className="p-6 pb-8 space-y-6">
                ...
                <div className="space-y-3 bg-gray-50 p-4 rounded-lg">
                  <p className="text-sm font-medium text-gray-900">Have you received overtime pay in the last 6 months?</p>
                ...
                {/* Share Button - Only enabled if question answered */}
                <button
                  onClick={handleShare}
                  disabled={isPaidYes === null || isSubmitting}
                  className={`w-full py-4 px-6 rounded-full font-semibold text-base text-white transition-colors ${
                    isPaidYes === null || isSubmitting
                      ? "bg-gray-400 cursor-not-allowed"
                      : "bg-black hover:bg-gray-800"
                  }`}
                >
                  {isSubmitting ? "Continuing..." : "Share Details"}
                </button>
              </div>
            )}
          </div>
