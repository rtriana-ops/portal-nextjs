...
export default function PortalBaseDesignPage() {
      ...
      {isSidebarOpen && (
        ...
        <main className="flex-1 px-4 py-4 lg:py-8">
          ...
          <div className="bg-transparent lg:bg-white rounded-2xl border p-6 lg:p-8 w-full md:max-w-[600px] xl:max-w-[1100px] border-gray-200 shadow-none lg:shadow-md px-0 py-0 md:mx-auto lg:ml-0 lg:mt-20">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-8">
              ...
              <div className="hidden lg:relative" ref={dropdownRef}>
                ...
                >
                  ...
                  <span className="text-gray-900 text-sm font-serif font-normal">Leslie Knope</span>
            ...
            {/* Card */}
            <div className="bg-white rounded-2xl p-6 lg:p-8 max-w-lg shadow-sm border border-gray-200 mb-12 mx-auto lg:ml-0">
              <div className="w-12 h-12 bg-blue-900 rounded-lg flex items-center justify-center mb-6">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <h3 className="text-lg font-bold text-gray-900 font-sans mb-4">Time for a quick update!</h3>
              <p className="text-gray-600 mb-6 font-sans">
                Re-sign your agreement to stay current with Fundo's latest terms and keep everything running smoothly.
              </p>
              <button className="px-6 py-2 bg-blue-600 text-white rounded-full font-medium hover:bg-blue-700 transition-colors font-sans">
                Update now
              </button>
            </div>
          </div>
