...
export default function PortalUnsubscribe3Page() {
  return (
      ...
      <main className="flex-1 px-4 lg:px-8 py-8 lg:py-12 bg-gray-100">
        <div className="max-w-md mx-auto space-y-8 text-center">
          ...
          <div className="flex justify-center pt-4">
            <img
              src="/images/happy-email.webp"
              alt="Person happily holding email"
          ...
          <div className="border-2 border-gray-300 rounded-3xl p-6 bg-white flex items-start gap-4">
            ...
            <div className="flex-1 text-left">
              <p className="text-gray-900 font-sans text-base leading-relaxed">
                You'll keep receiving <span className="font-bold">updates, funding insights, and special offers</span> from Fundo.
              </p>
            </div>
          ...
          {/* Secondary Text */}
          <p className="text-gray-900 text-base font-medium font-sans">
          ...
          <div className="space-y-2 pt-4">
            <p className="text-gray-700 text-sm font-sans">
              You can contact Fundo Customer Service now at <span className="font-bold">(866) 393-8636</span>
            </p>
          </div>
        </div>
      </main>
