...
export default function LoaderLayerMockupPage() {
  ...
  useEffect(() => {
    ...
    const bullet4Timer = setTimeout(() => {
      setVisibleBullets([1, 2, 3, 4])
      setAllBulletsDone(true)
    }, 3000)

    // Show Layer mockup after 9 seconds
    const layerMockupTimer = setTimeout(() => {
          ...
          <div className="flex flex-col items-center space-y-8">
            ...
            <div className="w-full space-y-4">
              ...
              >
                ...
                <p className="text-gray-900 text-base font-sans font-normal">Reviewing your information</p>
              </div>
              ...
              >
                ...
                <p className="text-gray-900 text-base">Verifying your connection</p>
              </div>
              ...
              >
                ...
                <p className="text-slate-950 font-sans font-normal text-base">Personalizing your experience</p>
              </div>

              {/* Bullet 4 - Pulsing (Currently processing) */}
              <div
                className={`flex items-center gap-3 transition-all duration-[2000ms] ${
          ...
          <div className="w-full lg:w-[540px] bg-white rounded-t-3xl lg:rounded-3xl p-8 max-h-[90vh] overflow-y-auto lg:max-h-[80vh]">
            ...
            <div className="max-w-md mx-auto text-center pt-4 space-y-2.5">
              ...
              <h2 className="font-bold text-gray-900 text-lg">
                Fundo uses <span className="font-black">PLAID LAYER</span> to connect your account
              </h2>

              {/* Prototype Note */}
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 px-1.5 py-1.5">
