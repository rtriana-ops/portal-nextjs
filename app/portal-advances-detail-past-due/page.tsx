...
export default function PortalAdvancesDetailPastDuePage() {
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-0">
              ...
              <div className="lg:mb-0 mb-1.5">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:gap-4 gap-1">
                  ...
                  <span className="inline-flex items-center w-fit bg-red-100 text-red-800 text-xs font-semibold px-3 py-1 rounded-full">Active</span>
                </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 mb-3 gap-2.5">
                ...
                <div className="bg-gray-100 rounded-2xl p-5">
                  ...
                  <p className="text-xl font-bold text-green-600">$560.00</p>
                </div>
                  ...
                  <div className="bg-red-50 rounded-lg p-4 border border-red-200">
                    <div className="flex justify-between gap-2 mb-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div>
                          <h3 className="font-semibold text-gray-900">Past-due</h3>
                          <p className="text-xs text-red-600 mt-1">you have a payment that was not completed on time</p>
                        </div>
                      </div>
                      <p className="text-lg font-bold text-red-600">$93.33</p>
                    </div>
                  ...
                  <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        <p className="text-lg font-bold text-gray-900">March 28, 2025</p>
                      </div>
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 p-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                        ...
                        <span className="text-sm font-semibold text-gray-900">9 of 20</span>
                      </div>
                    </div>
                  </div>
                </div>
                        ...
                        <div key={idx} className="flex items-center justify-between py-2 border-b border-gray-100 last:border-0">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              {idx === 0 && payment.status === 'Overdue' && (
                                <p className="text-xs text-red-600 font-semibold">Payment past-due</p>
                              )}
                            </div>
                          </div>
