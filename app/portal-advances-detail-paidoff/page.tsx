...
export default function PortalAdvancesDetailPaidOffPage() {
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-0">
              ...
              <div className="lg:mb-0 mb-1.5">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:gap-4 gap-1">
                  <h2 className="text-3xl font-bold text-gray-900">$625.00</h2>
                  <span className="inline-flex items-center w-fit bg-gray-400 text-white text-xs font-semibold px-3 py-1 rounded-full">Paid-off</span>
                </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 mb-3 gap-2.5">
                ...
                <div className="bg-gray-100 rounded-2xl p-5">
                  ...
                  <p className="text-xl font-bold text-gray-900">$1,025.00</p>
                </div>
                ...
                <div className="bg-gray-100 rounded-2xl p-5">
                  ...
                  <p className="text-xl font-bold text-green-600">$1,025.00</p>
                </div>
                  ...
                  <div className="bg-white rounded-lg border border-gray-200 p-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                        ...
                        <span className="text-sm font-semibold text-gray-900">October 15, 2025</span>
                      </div>
                      <div className="flex justify-between items-center pb-3 border-b border-gray-200">
                        <span className="text-sm text-gray-600">Payment Progress</span>
                        <span className="text-sm font-semibold text-gray-900">20 of 20</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    ...
                    <div className="space-y-3 max-h-96 overflow-y-auto">
                      {[
                        { date: 'March 01, 2026', amount: '$93.33', status: 'Paid', paymentNum: '10' },
                        { date: 'March 01, 2026', amount: '$93.33', status: 'Paid', paymentNum: '9' },
                        { date: 'February 28, 2026', amount: '$93.33', status: 'Paid', paymentNum: '8' },
