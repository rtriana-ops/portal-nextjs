...
export default function PortalAdvancesDetailVoidedPage() {
    ...
    <>
      ...
      <main className="flex-1 flex items-start justify-center">
        {showSkeleton ? (
          ...
          <div className="bg-transparent lg:bg-white rounded-2xl border p-4 lg:p-8 w-full md:max-w-[600px] xl:max-w-[1100px] border-gray-200 shadow-none lg:shadow-md md:mx-auto lg:ml-0 lg:mt-20">
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-0">
              ...
              <div className="lg:mb-0 mb-1.5">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:gap-4 gap-1">
                  <h2 className="text-3xl font-bold text-gray-900">$1,875.00</h2>
                  <span className="inline-flex items-center w-fit bg-gray-400 text-white text-xs font-semibold px-3 py-1 rounded-full">Voided</span>
                </div>
                <p className="text-gray-600 text-sm mt-0">Funded: Nov 14, 2025</p>
              </div>
            ...
            <div className="mt-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 mb-3 gap-2.5">
                ...
                <div className="bg-gray-100 rounded-2xl p-5">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <span className="text-xs text-gray-600 pt-2">Total cost of Capital</span>
                  </div>
                  <p className="text-xl font-bold text-gray-900">$1,866.00</p>
                </div>
                ...
                <div className="bg-gray-100 rounded-2xl p-5">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <span className="text-xs text-gray-600 pt-2">Balance</span>
                  </div>
                ...
                <div className="bg-gray-100 rounded-2xl p-5">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <span className="text-xs text-gray-600 pt-2">Total Paid</span>
                  </div>
                  <p className="text-xl font-bold text-gray-900">$0.00</p>
                </div>
                ...
                <div className="bg-gray-100 rounded-2xl p-5">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <span className="text-xs text-gray-600 pt-2">Payments Left</span>
                  </div>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mt-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-amber-900">Voided Advance</p>
                    <p className="text-sm text-amber-800 mt-1">This advance has been voided because you decided not to proceed with taking this advance.</p>
                  </div>
                </div>
              </div>
