...
export default function PortalAdvancesDetailEmptyStatePage() {
            ...
            <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-0">
              ...
              <div className="lg:mb-0 mb-1.5">
                ...
                <div className="flex flex-col lg:flex-row lg:items-center lg:gap-4 gap-1">
                  ...
                  <span className="inline-flex items-center w-fit bg-green-100 text-green-800 text-xs font-semibold px-3 py-1 rounded-full">Active</span>
                </div>
              ...
              <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 mb-3 gap-2.5">
                ...
                <div className="bg-gray-100 rounded-2xl p-5">
                  <div className="flex items-start gap-3 mb-3">
                    ...
                    <span className="text-xs text-gray-600 pt-2">Original Amount</span>
                  </div>
                  ...
                  <div className="bg-green-50 rounded-lg p-4 border border-green-200">
                    ...
                    <div className="space-y-2">
                      <div>
                        ...
                        <p className="text-lg font-bold text-gray-900">No upcoming payments</p>
                      </div>
                ...
                <div className="space-y-3">
                  ...
                  <div className="bg-white rounded-lg p-4 border border-gray-200">
                    ...
                    <div className="flex items-center gap-3 py-8 justify-center">
                      ...
                      <p className="text-gray-600 font-medium">No payment history available yet</p>
                    </div>
                  </div>
